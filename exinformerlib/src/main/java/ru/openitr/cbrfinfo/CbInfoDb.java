...
public abstract class CbInfoDb {
    ...
    public static final String CUR_KEY_DELTA = "vPriceDelta";
    ...
    public static final int VALDELTA_COLNUM = 9;
    ...
    public static final String MET_KEY_DELTA = "mPriceDelta";
    ...
    public static final int MET_DELTA_COL_NUM = 7;

    public static final String[] MET_ALL_COLUMNS = {MET_KEY_ID, MET_KEY_CODE, MET_KEY_PRICE, MET_KEY_DATE, MET_KEY_IMAGE_URI, MET_KEY_VISIBLE, MET_KEY_ORDER, MET_KEY_DELTA};
    ...
    protected static final String CREATE_CUR_TABLE = "create table " +
            ...
            CUR_KEY_DELTA + " real" +
            ");";
    protected static final String CREATE_CURTABLE_TRIGGER_1 =
            "CREATE TRIGGER \"" + CURRENCY_TABLE + "_before_update_set_delta\" " +
            "AFTER  UPDATE  OF " + CUR_KEY_VCURS +" ON " + CURRENCY_TABLE + " " +
            "BEGIN " +
            "update " + CURRENCY_TABLE +" set " + CUR_KEY_DELTA + " = new." + CUR_KEY_VCURS + " - old." + CUR_KEY_VCURS +
                    " where " + CUR_KEY_CHARCODE + " = " + "new." + CUR_KEY_CHARCODE + "; " +
            "END; ";
    ...
    protected static final String [] INSERT_CURRENCY_DATA = {"insert into curtable (\"_id\", \"vCode\", \"vchCode\", \"vCurs\", \"vName\", \"vDate\", \"vFlagImageUri\", \"vVisible\", \"vOrder\") values ('1', '36', 'AUD', '0', 'Австралийский доллар', '0', NULL, NULL, 3);",
            ...
            "insert into curtable (\"_id\", \"vCode\", \"vchCode\", \"vCurs\", \"vName\", \"vDate\", \"vFlagImageUri\", \"vVisible\", \"vOrder\") values ('18', '440', 'LTL', '0.0', 'Литовский лит', '0', NULL, NULL, 16);",
            "insert into curtable (\"_id\", \"vCode\", \"vchCode\", \"vCurs\", \"vName\", \"vDate\", \"vFlagImageUri\", \"vVisible\", \"vOrder\") values ('19', '498', 'MDL', '0.0', 'Молдавский лей', '0', NULL, NULL, 17);",
            "insert into curtable (\"_id\", \"vCode\", \"vchCode\", \"vCurs\", \"vName\", \"vDate\", \"vFlagImageUri\", \"vVisible\", \"vOrder\") values ('20', '578', 'NOK', '0.0', 'Норвежская крона', '0', NULL, NULL, 18);",
            "insert into curtable (\"_id\", \"vCode\", \"vchCode\", \"vCurs\", \"vName\", \"vDate\", \"vFlagImageUri\", \"vVisible\", \"vOrder\") values ('21', '985', 'PLN', '0.0', 'Польский злотый', '0', NULL, NULL, 19);",
            "insert into curtable (\"_id\", \"vCode\", \"vchCode\", \"vCurs\", \"vName\", \"vDate\", \"vFlagImageUri\", \"vVisible\", \"vOrder\") values ('22', '946', 'RON', '0.0', 'Новый румынский лей', '0', NULL, NULL, 20);",
            "insert into curtable (\"_id\", \"vCode\", \"vchCode\", \"vCurs\", \"vName\", \"vDate\", \"vFlagImageUri\", \"vVisible\", \"vOrder\") values ('23', '960', 'XDR', '0.0', 'СДР (специальные права заимствования)', '0', NULL, NULL, 21);",
            "insert into curtable (\"_id\", \"vCode\", \"vchCode\", \"vCurs\", \"vName\", \"vDate\", \"vFlagImageUri\", \"vVisible\", \"vOrder\") values ('24', '702', 'SGD', '0.0', 'Сингапурский доллар', '0', NULL, NULL, 22);",
            "insert into curtable (\"_id\", \"vCode\", \"vchCode\", \"vCurs\", \"vName\", \"vDate\", \"vFlagImageUri\", \"vVisible\", \"vOrder\") values ('25', '972', 'TJS', '0.0', 'Таджикский сомони', '0', NULL, NULL, 23);",
            "insert into curtable (\"_id\", \"vCode\", \"vchCode\", \"vCurs\", \"vName\", \"vDate\", \"vFlagImageUri\", \"vVisible\", \"vOrder\") values ('26', '949', 'TRY', '0.0', 'Турецкая лира', '0', NULL, NULL, 24);",
            "insert into curtable (\"_id\", \"vCode\", \"vchCode\", \"vCurs\", \"vName\", \"vDate\", \"vFlagImageUri\", \"vVisible\", \"vOrder\") values ('27', '934', 'TMT', '0.0', 'Новый туркменский манат', '0', NULL, NULL, 25);",
            "insert into curtable (\"_id\", \"vCode\", \"vchCode\", \"vCurs\", \"vName\", \"vDate\", \"vFlagImageUri\", \"vVisible\", \"vOrder\") values ('28', '860', 'UZS', '0.0', 'Узбекский сум', '0', NULL, NULL, 26);",
            "insert into curtable (\"_id\", \"vCode\", \"vchCode\", \"vCurs\", \"vName\", \"vDate\", \"vFlagImageUri\", \"vVisible\", \"vOrder\") values ('29', '980', 'UAH', '0.0', 'Украинская гривна', '0', NULL, NULL, 27);",
            "insert into curtable (\"_id\", \"vCode\", \"vchCode\", \"vCurs\", \"vName\", \"vDate\", \"vFlagImageUri\", \"vVisible\", \"vOrder\") values ('30', '203', 'CZK', '0.0', 'Чешская крона', '0', NULL, NULL, 28);",
            "insert into curtable (\"_id\", \"vCode\", \"vchCode\", \"vCurs\", \"vName\", \"vDate\", \"vFlagImageUri\", \"vVisible\", \"vOrder\") values ('31', '752', 'SEK', '0.0', 'Шведская крона', '0', NULL, NULL, 29);",
            "insert into curtable (\"_id\", \"vCode\", \"vchCode\", \"vCurs\", \"vName\", \"vDate\", \"vFlagImageUri\", \"vVisible\", \"vOrder\") values ('32', '756', 'CHF', '0.0', 'Швейцарский франк', '0', NULL, NULL, 30);",
            "insert into curtable (\"_id\", \"vCode\", \"vchCode\", \"vCurs\", \"vName\", \"vDate\", \"vFlagImageUri\", \"vVisible\", \"vOrder\") values ('33', '710', 'ZAR', '0.0', 'Южноафриканский рэнд', '0', NULL, NULL, 31);",
            "insert into curtable (\"_id\", \"vCode\", \"vchCode\", \"vCurs\", \"vName\", \"vDate\", \"vFlagImageUri\", \"vVisible\", \"vOrder\") values ('34', '410', 'KRW', '0.0', 'Вон Республики Корея', '0', NULL, NULL, 32);",
            "insert into curtable (\"_id\", \"vCode\", \"vchCode\", \"vCurs\", \"vName\", \"vDate\", \"vFlagImageUri\", \"vVisible\", \"vOrder\") values ('35', '392', 'JPY', '0.0', 'Японская иена', '0', NULL, NULL, 33);"};
    ...
    protected static final String CREATE_METALTABLE_TRIGGER_1 =
            "CREATE TRIGGER \""+ METAL_TABLE +"_before_update_up_direct\"" +
                    "   AFTER  UPDATE OF mPrice" +
                    "   ON " + METAL_TABLE + " " +
//                    "   WHEN new.mPrice > old.mPrice " +
                    "BEGIN " +
                    "    update " + METAL_TABLE + " set " + MET_KEY_DELTA + " =  new." + MET_KEY_PRICE +
                    " - old." + MET_KEY_PRICE +
                    "       where " + MET_KEY_CODE + " = new." + MET_KEY_CODE + "; " +
                    "END; ";
    ...
    public static final String[] CUR_ALL_COLUMNS = {CUR_KEY_ID, CUR_KEY_CODE, CUR_KEY_CHARCODE, CUR_KEY_VCURS, CUR_KEY_VNAME, CUR_KEY_DATE, CUR_KEY_IMAGE_URI, CUR_KEY_VISIBLE, CUR_KEY_ORDER, CUR_KEY_DELTA};
